...
static Double_t proj_mass = 32.990877687 * 931.494;
static Double_t target_mass = 2.01410177812 * 931.494;
static Double_t recoil_mass = 33.005327245 * 931.494;
static Double_t he2_mass = 2.0 * proton_mass;
static Double_t Ekin_proj = 94.5* 32.990877687;//86
// static Double_t decay_frag_mass = 31.999110139*931.494 / 1000; // GeV/c^2
static Double_t decay_frag_mass = 33.005327245*931.494 / 1000; // GeV/c^2
...
void ana_d2He_33Al()
{
   ...
   TString digiFileName =
      "/mnt/analysis/e18008/rootAna/giraud/simulation/digi/attpcdigi_d2He_5000_run0_Ex2_33Al.root";
      ...
      for (Int_t ipoint = 0; ipoint < Npoints; ipoint++) {
         ...
         if (trackID == 1 && VolName == "drift_volume") { // beam-like 1; decay like 4
            ...
            if (point->GetZ() >= 100) {
               ...
               Eje_ene = Eeje;
               // Eje_dta = (Eeje - 2.18) / 2666.61 - 1.0; // 2753.20: 32Na 3.97Tm // 2666.61: 31Na 3.85Tm
               Eje_dta = (Eeje - 2.18) / 3118.38 - 1.0; //3118.38: 33Mg 3.95Tm // 3023.29: 32Mg 3.82Tm
