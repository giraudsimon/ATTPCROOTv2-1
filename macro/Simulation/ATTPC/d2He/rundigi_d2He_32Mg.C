void rundigi_d2He_32Mg(Int_t runNumber = 0, Double_t ExEje = 0)
{
   TString mcFile = Form("/mnt/analysis/e18008/rootAna/giraud/simulation/g4/attpcsim_d2He_run%d_Ex%d_32Mg_decay.root",
