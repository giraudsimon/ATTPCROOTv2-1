...
void unpack(int runNumberS800 = 108, int runNumberATTPC = 108)
{
...
//   TString inputFile = TString::Format("run_%04d.h5", runNumberATTPC);
  TString inputFile = TString::Format("/mnt/analysis/e21018/e22502_run_%04d.h5", runNumberATTPC);///mnt/analysis/e21018/e22502_run_0108.h5
  ...
  TString outputFile = TString::Format("run_%04d_test_e22502.root", runNumberATTPC);
 ...
 /* TString parameterFile = "ATTPC.d2He.21018.par"; */
 TString parameterFile = "par.e21018/ATTPC_e21018.par";
...
//   TString S800File = TString::Format("/mnt/analysis/e18008/rootS800/cal/run-%04d-00.root", runNumberS800);
  // TString S800File = TString::Format("/mnt/analysis/e21018/rootS800/cal/testEvt2Raw_run1020_calib.root");
  TString S800File = TString::Format("/mnt/analysis/e21018/rootS800/cal/run-1020-00.root");
  ...
  MergeEvt->SetATTPCClock(kFALSE);         // if kTRUE for HDFParser SetTimestampIndex(1) (use internal timestamp)
